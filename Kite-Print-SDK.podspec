Pod::Spec.new do |spec|
  ...
  spec.summary          = 'Easily add print on demand functionality to your app. Print magnets, photo prints, postcards, polaroids, A4, posters, stickers, canvases, phone cases, etc.'
