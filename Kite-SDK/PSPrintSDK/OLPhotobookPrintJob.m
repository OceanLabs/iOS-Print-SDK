...
- (BOOL)isEqual:(id)object {
    ...
    return [self.templateId isEqual:printJob.templateId] && [self.assets isEqualToArray:printJob.assets] && [self.frontCover isEqual:printJob.frontCover] && [self.backCover isEqual:printJob.backCover] && [self.options isEqualToDictionary:printJob.options];
}
