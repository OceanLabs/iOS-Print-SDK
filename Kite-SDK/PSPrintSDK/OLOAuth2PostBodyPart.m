...
#import "OLOAuth2FileStreamWrapper.h"

#import "OLOAuth2PostBodyPart.h"


@interface OLOAuth2PostBodyPart(Private)
...
@implementation OLOAuth2PostBodyPart
...
- (id)initWithName:(NSString *)name content:(id)content;
{
    if ([content isKindOfClass:[NSString class]]) {
    ...
    } else if ([content isKindOfClass:[OLOAuth2FileStreamWrapper class]]) {
        ...
        NSAssert1(NO, @"OLOAuth2PostBodyPart with illegal type:\n%@", [content class]);
        return nil;
    }
}
